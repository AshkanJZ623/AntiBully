...
def get_args():
    ...
    parser.add_argument('-sa', '--save', help='Save the model', action='store_true', default=False)
    ...
    # DATA
    parser.add_argument('-dt', '--dataset', help='en/de/en+de/kids', type=str, required=True, default='kids')
